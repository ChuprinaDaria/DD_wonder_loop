...
📲Всі пости з лотами будуть пуьоіккуватися в групі https://t.me/wonder_loop
"""
    ...
    base_message += "Дякуємо, що з нами —тут можна чесно, спокійно і навіть із мемчиками відпустити все, що не зайшло 💅\n"
