...
📲Всі пости з лотами будуть публікуватися в групі https://t.me/wonder_loop
"""
    
    if is_trusted:
        base_message += "\n🔥 Ой а ви  Wonder Trust !\n"
        base_message += "• Ваші пости публікуються автоматично\n"
        base_message += "• Змінювати статуси своїх лотів\n"
        base_message += "• 10 постів на день, і жодного сорому\n"
        base_message += "• Ознайомитись з правилами [не нудні, клянемся]\n"
    ...
    base_message += "Дякуємо, що з нами —тут можна чесно, спокійно і навіть із гумором відпустити все, що не зайшло 💅\n"
