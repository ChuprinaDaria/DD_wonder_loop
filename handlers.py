...
❗ порушив правила → 1 попередження → бан
...
✔️ мініки, саше, тревел-формати — ок, якщо вже твої і не з готелю у Шарм-еш-Шейху з 2019 року
✔️ обмін — якщо хочеш поміняти на щось інше, кажи чесно, що шукаєш
...
✅ЯК ВИСТАВИТИ ЛОТ:
📸 фото — чіткі, своі, не на фоні пледа, ніг або чужого живота
🧴 назва продукту — повна
...
🧠 тип шкіри і чому не підійшло (будьте чесним — нам не треба ідеальна репутація банк)
📍 місто та спосіб передачі / доставки
💰 ціна або умови обміну

🗓ФОРМАТ ПУБЛІКАЦІЇ:
– 1 пост = 1 засіб, максимум 3 фото
– якщо набір — продається разом, всі банки на одному фото, без колажів
...
✅повний перелік правил: тут буде посилання на пдф файл
"""
